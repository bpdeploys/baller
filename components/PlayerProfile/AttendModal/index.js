import styles from './attendmodal.module.scss'; // Import the SCSS module

const AttendModal = ({ player, isOpen, onClose }) => {
    ...
    <div className={styles.backdrop} onClick={onClose}>
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.content}>
          <h3>Game On!</h3>
          <p>
            Arrive at least 10 minutes early to get warmed up and ready to play!
          </p>
